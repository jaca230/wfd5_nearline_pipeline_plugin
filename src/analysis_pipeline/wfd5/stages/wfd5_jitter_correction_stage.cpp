...
ClassImp(wfd5_jitter_correction_stage)

wfd5_jitter_correction_stage::wfd5_jitter_correction_stage() = default;

void wfd5_jitter_correction_stage::OnInit() {
...
void wfd5_jitter_correction_stage::Process() {
