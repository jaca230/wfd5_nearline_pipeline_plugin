#include "analysis_pipeline/wfd5/stages/rf_fit_stage.h"

#include <TParameter.h>
#include <spdlog/spdlog.h>

ClassImp(rf_fit_stage)

rf_fit_stage::rf_fit_stage() = default;

void rf_fit_stage::OnInit() {
