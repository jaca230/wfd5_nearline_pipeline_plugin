#include "analysis_pipeline/wfd5/stages/identify_pileup_from_fits_stage.h"

#include <TParameter.h>
#include <spdlog/spdlog.h>

ClassImp(identify_pileup_from_fits_stage)

identify_pileup_from_fits_stage::identify_pileup_from_fits_stage() = default;

void identify_pileup_from_fits_stage::OnInit() {
...
void identify_pileup_from_fits_stage::Process() {
